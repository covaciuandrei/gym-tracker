...
abstract final class AppColors {
  ...
  static const Color statsBlue = Color(0xFF3B82F6);

  // ── Additional stats colors from older app design ───────────────────────────
  static const Color statsBluePurple = Color(0xFF5A4FFC); // Blue/Purple gradient
  static const Color statsBluePurpleDark = Color(0xFF423D9F); // Dark blue/purple
  static const Color statsPinkRed = Color(0xFFE91E63); // Pink/Red gradient
  static const Color statsPinkRedDark = Color(0xFFC2185B); // Dark pink/red
  static const Color statsPurple = Color(0xFF9C27B0); // Purple gradient
  static const Color statsPurpleDark = Color(0xFF7B1FA2); // Dark purple
  static const Color statsOrange = Color(0xFFFF9800); // Orange gradient
  static const Color statsOrangeDark = Color(0xFFF57C00); // Dark orange
  static const Color statsOrangeAlt = Color(0xFFFF6A00); // Alternative orange
  static const Color statsOrangeAltDark = Color(0xFFE2552A); // Alternative dark orange
}
